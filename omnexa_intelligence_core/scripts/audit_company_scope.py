#!/usr/bin/env python3
"""Audit company/branch scoping — omnexa_intelligence_core."""
...
def run():
	...
	return {"ok": True, "app": "omnexa_intelligence_core", "company": company, "branch": branch, "uses_session_context": bool(company)}
